              ...
              {activeTab === 'home' && (
                <div className="flex gap-8 p-4 h-[72px] bg-white rounded-b-xl items-center">
                  ...
                  <div className="flex gap-2">
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          variant="ghost"
                          size="sm"
                          className="p-2 h-8 w-8 hover:bg-gray-50 text-gray-700"
                          onClick={onZoomAll}
                        >
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          variant="ghost"
                          size="sm"
                          className="p-2 h-8 w-8 disabled:opacity-30 hover:bg-gray-50 text-gray-700"
                    ...
                    <div className="text-xs text-gray-600 px-1 min-w-[2.5rem] text-center flex items-center">
