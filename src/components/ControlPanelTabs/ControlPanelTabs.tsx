...
const ControlPanelTabs = ({ activeTab, onTabChange, isPanelOpen }: ControlPanelTabsProps) => {
  ...
  return (
    <TooltipProvider>
      {/* Repositioned to avoid collision with panels */}
      <div className="fixed right-4 top-1/4 bg-slate-800/95 backdrop-blur-sm border border-slate-700/50 rounded-lg p-2 z-50 shadow-lg">
